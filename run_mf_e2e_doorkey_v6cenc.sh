...
# Experiment — DoorKey-8x8, v6c encoder ablation
# RGB + coords + full-width trunk (no capacity split)
# Tests: is v6's narrow trunk hurting door/key/wall accuracy?

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$SCRIPT_DIR"
RUN_NAME="doorkey_v6cenc_ablation"
