...
# Experiment — DoorKey-8x8, v6b encoder ablation
# Coordinate grid only (no RGB shortcut)
# Tests: does absolute position alone explain v6's goal grounding?

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$SCRIPT_DIR"
RUN_NAME="doorkey_v6benc_ablation"
