...
def analyze_codebook(args):
    # output dirs
    out_dir = getattr(args, "out_dir", None) or os.path.join("analysis", "codebook_semantics")
...
def main():
    ...
    parser.add_argument("--ckpt", type=str, default=None, help="Path to encoder checkpoint (.pt file)")
    parser.add_argument("--out_dir", type=str, default=None, help="Output directory for analysis results (default: analysis/codebook_semantics)")
